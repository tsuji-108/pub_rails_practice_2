...
class DiscussionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create discussion" do
    assert_difference("Discussion.count") do
      post discussions_url, params: { discussion: { board_id: @discussion.board_id, description: @discussion.description, title: @discussion.title, user_id: @discussion.user_id } }
    end
  ...
  test "should update discussion" do
    patch discussion_url(@discussion), params: { discussion: { board_id: @discussion.board_id, description: @discussion.description, title: @discussion.title, user_id: @discussion.user_id } }
